        ...
        <div class="md:flex md:justify-between">
          ...
          <div class="mb-6 md:mb-0">
            <Link to="/" class="flex items-center">
              <img
                src={prohealthImage} alt="Pro Health"/>
            </Link>
            <div>
            <h2 class="mt-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">
                Giới Thiệu
            </h2>
            <span className="">ProHealth cung cấp nền tảng để sinh viên dễ dàng quản lí sức khỏe một cách hiệu quả</span>
            </div>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="">
                     Address: 255 Nguyễn Văn Linh, Đà Nẵng
                </li>
                <li>
                    Phone: (123) 456-7890
                </li>
                <li>
                    Email: example@dtu.edu.vn
                </li>
              </ul>
            </div>
            <div>
