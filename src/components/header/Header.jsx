...
const Header = () => {
    ...
    return (
        <header className="shadow">
            <nav className="max-w-[1200px] mx-auto bg-white border-gray-200 px-4 lg:px-6 py-5">
                <div className="w-full flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link to="/" className="flex items-center">
                        <img src={prohealthImage}  className="mr-3 h-6 sm:h-9" alt="ProHealth" />
                    </Link>
                    <div className="flex items-center lg:order-2">
                        ...
                        {isLogin ? <div className="relative">
                            ...
                            <div id="dropdown"
                                ...
                                <ul className="py-2 px-2 text-sm text-gray-700 font-semibold"
                                    ...
                                    <li className="flex items-center hover:bg-primaryColor hover:text-white rounded">
                                        ...
                                        <Link to="/"
                                              className="block pr-4 py-2">Hồ Sơ Cá Nhân</Link>
                                    </li>
                            ...
                            to="/login"
                            className="text-gray-800 hover:bg-gray-200 transition-all hover:text-primaryColor font-bold rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 "
                        >
                            Đăng Nhập
                        </Link>
                            <Link
